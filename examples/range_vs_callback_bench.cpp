...
public:
    ...
    template <class Self>
    static void define_cached_fields(Self& s, const FieldKeyReader& v) {
        v.key<&Widget::category>(s.category, "category");
    }
};
