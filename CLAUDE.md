...
- A comment **within a function** is a single focused line. Use a second line only when one line genuinely cannot carry the non-obvious why, and never a third. An explanation that needs more than two lines means the code needs restructuring.
